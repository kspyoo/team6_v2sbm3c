...
COMMENT ON TABLE CURTUREFACILITY is '문화시설';
COMMENT ON COLUMN CURTUREFACILITY.CULTUREFNO is '문화시설번호';
COMMENT ON COLUMN CURTUREFACILITY.CNAME is '문화시설이름';
COMMENT ON COLUMN CURTUREFACILITY.RADDRESS is '도로명 주소';
COMMENT ON COLUMN CURTUREFACILITY.LATITUDE is '위도';
COMMENT ON COLUMN CURTUREFACILITY.LONGITUDE is '경도';
COMMENT ON COLUMN CURTUREFACILITY.ADDR_CODE is '우편번호';
COMMENT ON COLUMN CURTUREFACILITY.PHONE is '전화번호';
COMMENT ON COLUMN CURTUREFACILITY.CLOSEDDAYS is '휴무일';
COMMENT ON COLUMN CURTUREFACILITY.OPERATINGTIME is '운영시간';
COMMENT ON COLUMN CURTUREFACILITY.PA is '주차가능여부';
COMMENT ON COLUMN CURTUREFACILITY.MASTERNO is '관리자번호';
...
CREATE TABLE MATECOMMUNITY(
		...
		WDATE                         		DATE		 NOT NULL,
		ASSEMBLETIME                  		VARCHAR2(30)		 NOT NULL,
...
COMMENT ON COLUMN MATECOMMUNITY.STATUS is '모집 상태';
...
CREATE TABLE FACILITYREVIEW(
  ...
  FOREIGN KEY (CULTUREFNO) REFERENCES CURTUREFACILITY (CULTUREFNO),
  FOREIGN KEY (MEMBERNO) REFERENCES member (MEMBERNO)
);
...
CREATE TABLE Memberprofile(
		...
		file1MF                       		VARCHAR2(100)		 NOT NULL,
		size1_label                   		VARCHAR2(100)		 NOT NULL,
		file1                         		INTEGER(10)		 NOT NULL,
...
COMMENT ON COLUMN Memberprofile.size1_label is '메인이미지크기';
...
CREATE TABLE CULTUREFILE(
		...
		FILE1MF                       		VARCHAR2(100)		 NULL ,
		SIZE1                         		VARCHAR2(100)		 NULL ,
		FILE1                         		INTEGER(10)		 NULL ,
		FILE1SAVED                    		VARCHAR2(100)		 NOT NULL,
		FILESIZE                      		VARCHAR2(100)		 NOT NULL,
		THUMBFILE                     		VARCHAR2(100)		 NOT NULL,
		CULTUREFNO                    		NUMBER(10)		 NULL ,
...
COMMENT ON TABLE CULTUREFILE is '회원 프로필 사진 수정';
COMMENT ON COLUMN CULTUREFILE.FANO is '파일번호';
COMMENT ON COLUMN CULTUREFILE.FILE1MF is '이미지파일';
...
COMMENT ON COLUMN CULTUREFILE.FILESIZE is '파일사이즈';
