...
public class MasterloginCont {
  ...
  public String list_search(HttpSession session, Model model, String word,
    ...
    if (session.getAttribute("masterno") != null) {
      ...
      String paging = this.masterloginProc.pagingBox(now_page, word, "/masterlogin/login_list", search_count,
