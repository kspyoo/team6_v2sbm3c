...
public class CulturefacilityCont {
  ...
  public String create(HttpSession session, Model model, CulturefacilityVO culturefacilityVO,
    ...
    if (session.getAttribute("masterno") != null) {
      ...
      // /templates/cate/create.html
    }
  }

  /**
   * create 폼 데이터 처리 http://localhost:9091/cate/list_search
   * 
   * @param model
   * @param cateVO
   * @param bindingResult
  ...
  public String create(Model model, @Valid CulturefacilityVO culturefacilityVO, BindingResult bindingResult,
    ...
    if (bindingResult.hasErrors()) {
      ...
      // 페이징 목록
      ArrayList<CulturefacilityVO> list = this.CulturefacilityProc.list_search_paging(word, now_page,
      ...
      String paging = this.CulturefacilityProc.pagingBox(now_page, word, "culturefacility/list_search", search_count,
...
//      model.addAttribute("namesub", cateVO.getNamesub());
  ...
  public String read(Model model, @PathVariable("culturefno") Integer culturefno,
      @RequestParam(name = "word", defaultValue = "") String word,
      @RequestParam(name = "now_page", defaultValue = "1") int now_page) {
...
//    return "culturefacility/read_cookie_reply"
  ...
  public String update(HttpSession session, Model model, @PathVariable("culturefno") Integer culturefno,
      @RequestParam(name = "word", defaultValue = "") String word,
      @RequestParam(name = "now_page", defaultValue = "1") int now_page) {
...
//    System.out.println("-> cnt: " + cnt);
    ...
    model.addAttribute("cnt", cnt);
    if (cnt == 1) {
      return "redirect:/culturefacility/update/" + culturefacilityVO.getCulturefno() + "?word=" + Tool.encode(word)
          + "&now_page=" + now_page;
  ...
  /**
   * Delete form http://localhost:9091/cate/delete/1
   * 
   * @param model
  ...
  public String delete(HttpSession session, Model model, @PathVariable("culturefno") Integer culturefno,
      @RequestParam(name = "word", defaultValue = "") String word,
      @RequestParam(name = "now_page", defaultValue = "1") int now_page) {
  ...
  /**
   * 등록폼 + 검색 목록 http://localhost:9091/cate/list_search?word=개발 ← GET Form
