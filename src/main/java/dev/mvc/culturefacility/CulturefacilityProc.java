...
public class CulturefacilityProc implements CulturefacilityProcInter  {
  ...
  public CulturefacilityVO read(int culturefno) {
    CulturefacilityVO culturefacilityVO =this.culturefacilityDAO.read(culturefno);
  ...
  public int delete(int culturefno) {
   int cnt =this.culturefacilityDAO.delete(culturefno);
    return cnt;
  }

  @Override
  public ArrayList<CulturefacilityVO> list_search(String word) {
    ArrayList<CulturefacilityVO> list= this.culturefacilityDAO.list_search(word);
    return list;
  }
  ...
  public ArrayList<CulturefacilityVO> list_search_paging(String word, int now_page, int record_per_page) {
    ...
    */
    ...
    ArrayList<CulturefacilityVO> list=this.culturefacilityDAO.list_search_paging(map);
    return list;
  ...
  public int list_search_count(String word) {
    int cnt =this.culturefacilityDAO.list_search_count(word);
    return cnt;
  }
