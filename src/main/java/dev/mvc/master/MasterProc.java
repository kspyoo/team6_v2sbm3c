...
public class MasterProc implements MasterProcInter{
  ...
  public ArrayList<MasterVO> list_search(String word) {
    ArrayList<MasterVO> list= this.masterDAO.list_search(word);
    return list;
  }

  @Override
  public ArrayList<MasterVO> list_search_paging(String word, int now_page, int record_per_page) {
    /*
    예) 페이지당 10개의 레코드 출력
    ...
    */
    ...
    ArrayList<MasterVO> list=this.masterDAO.list_search_paging(map);
    return list;
  ...
  public int list_search_count(String word) {
    int cnt =this.masterDAO.list_search_count(word);
    return cnt;
  }
